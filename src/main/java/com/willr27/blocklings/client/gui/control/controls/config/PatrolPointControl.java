    ...
    public PatrolPointControl(@Nonnull PatrolPoint patrolPoint)
    {
        ...
        TextBlockControl name = new TextBlockControl()
        {
            ...
            public void onTick()
            {
                ...
                setText(new BlocklingsComponent("config.patrol.point", 1 + PatrolPointControl.this.getParent().getChildren().indexOf(PatrolPointControl.this)));
            }
        };
        ...
        name.setText(new BlocklingsComponent("config.patrol.point", 1));
        ...
        waitTimeLabel.setText(new BlocklingsComponent("config.patrol.wait_time.name"));
