...
//        matrixStack.popPose();
    ...
    protected void renderRectangleAsBackground(@Nonnull PoseStack matrixStack, int colour)
    {
        renderRectangle(matrixStack, (int) getPixelX(), (int) getPixelY(), (int) getPixelWidth(), (int) getPixelHeight(), colour);
    }

    protected void renderRectangleAsBackground(@Nonnull PoseStack matrixStack, int colour, double dx, double dy, double width, double height)
    {
    ...
    protected void renderBackgroundColour(@Nonnull PoseStack matrixStack)
    {
        renderRectangleAsBackground(matrixStack, getBackgroundColourInt());
    }

    protected void renderTextureAsBackground(@Nonnull PoseStack matrixStack, @Nonnull Texture texture)
    {
        renderTexture(matrixStack, texture, getPixelX(), getPixelY(), getPixelScaleX(), getPixelScaleY());
    }

    protected void renderTextureAsBackground(@Nonnull PoseStack matrixStack, @Nonnull Texture texture, double dx, double dy)
    {
     ...
     */
    public void renderTooltip(@Nonnull PoseStack matrixStack, double mouseX, double mouseY, @Nonnull Component tooltip)
    {
     ...
     * @param mouseY the mouse y position.
     */
    public void renderTooltip(@Nonnull PoseStack matrixStack, @Nonnull List<? extends Component> tooltip, double mouseX, double mouseY)
    {
     ...
     * @param tooltip the tooltip to render.
     */
    public void renderTooltip(@Nonnull PoseStack matrixStack, double mouseX, double mouseY, @Nonnull List<FormattedCharSequence> tooltip)
    {
